...
describe('ProcessingPeriodResource', function() {
    ...
    beforeEach(function() {
        ...
        inject(function($injector) {
            this.ProcessingPeriodResource = $injector.get('ProcessingPeriodResource');
        });
    });

    it('should extend OpenlmisResource', function() {
        new this.ProcessingPeriodResource();

        expect(this.OpenlmisResourceMock).toHaveBeenCalledWith('/api/processingPeriods', {
            paginated: true
        });
    });
});